...
export default function HomePage() {
  ...
  return (
    <div className="pt-16">
      ...
      {/* ─── HERO ─────────────────────────────────────────────────────────── */}
      <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a]">
      ...
      {/* ─── UNITS GRID 2×4 ───────────────────────────────────────────────── */}
      <section className="bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] py-24 px-6 relative" ref={s2}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#d81300]/20 grid-rows-2 auto-rows-fr">
            {units.map(({ num, title, desc, tag, useLogo }, i) => (
              <div key={num}
                className={`io-reveal p-6 hover:bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] transition-all duration-300 group cursor-default flex flex-col ${
                  num === '↻' ? 'bg-[#d81300]/8' : 'bg-gradient-to-br from-[#141414] to-[#222222]'
                }`}
  ...
  <div className="mb-3">
    <LeaderInMeLogo className="w-20 h-20 object-contain" />
      ...
      {/* ─── SALT CALLOUT ─────────────────────────────────────────────────── */}
      <section className="bg-gradient-to-br from-[#141414] to-[#222222] py-20 px-6 relative overflow-hidden" ref={s3}>
      ...
      {/* ─── CAREERS CALLOUT ──────────────────────────────────────────────── */}
      <section className="bg-gradient-to-br from-[#141414] to-[#222222] py-16 px-6 relative" ref={s5}>
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#d81300] to-transparent" />
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-px bg-[#d81300]/15">
            {careerCards.map(({ title, desc, icon }, i) => (
              <div key={title}
                className="io-reveal bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] p-8 hover:bg-[#202020] transition-colors duration-300 group card-lift"
                data-delay={String(i * 80)}>
