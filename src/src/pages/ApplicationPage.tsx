...
export default function ApplicationPage() {
  ...
  if (status === 'success') {
    return (
      <div className="pt-16 min-h-screen bg-gradient-to-br from-[#141414] to-[#222222] flex items-center justify-center px-6">
  ...
  return (
    <div className="pt-16">
      {/* Header */}
      <section className="relative py-20 px-6 bg-gradient-to-br from-[#141414] to-[#222222] overflow-hidden">
        <div
