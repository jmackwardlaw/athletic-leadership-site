...
export default function AboutPage() {
  ...
  return (
    <div className="pt-16">
      ...
      {/* ── HEADER ────────────────────────────────────────────────────────── */}
      <section className="relative py-24 px-6 bg-gradient-to-br from-[#141414] to-[#222222] overflow-hidden">
        {/* Red top bar */}
  ...
  <span className="text-[#d81300]">Leader</span>ship
      ...
      <section className="bg-gradient-to-br from-[#141414] to-[#222222] py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] border border-[#d81300]/30 p-8 md:p-10">
              ...
              <div className="md:col-span-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    <div key={num} className="flex items-center gap-3 bg-gradient-to-br from-[#141414] to-[#222222] border border-white/5 px-3 py-2">
      ...
      {/* ── UNITS ────────────────────────────────────────────────────────── */}
      <section className="bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] py-20 px-6">
        <div className="max-w-7xl mx-auto">
              ...
              <div
                ...
                className={`p-6 hover:border-[#d81300]/40 transition-colors ${
                  highlight
                    ...
                    : 'bg-gradient-to-br from-[#141414] to-[#222222] border border-white/5'
                }`}
              >
      ...
      {/* ── CAPSTONE + INTERNSHIP ────────────────────────────────────────── */}
      <section className="bg-gradient-to-br from-[#141414] to-[#222222] py-20 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] border border-[#d81300]/30 p-8">
          ...
          <div className="bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] border border-white/10 p-8">
