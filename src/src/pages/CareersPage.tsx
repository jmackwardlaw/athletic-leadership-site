...
export default function CareersPage() {
  ...
  return (
    <div className="pt-16">
      ...
      {/* CATEGORY FILTER */}
      <div className="bg-gradient-to-br from-[#141414] to-[#222222] border-b border-white/5 sticky top-[57px] z-40">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 text-xs font-black tracking-[0.08em] uppercase whitespace-nowrap transition-all duration-200 flex-shrink-0 ${
                  activeCategory === key
                    ...
                    : 'bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] text-gray-400 hover:text-white border border-white/10 hover:border-white/25'
                }`}>
                {key !== 'all' && (
      ...
      {/* CAREER CARDS */}
      <section className="bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] py-12 px-6" ref={s1}>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {filtered.map((path) => {
              ...
              return (
                <div
                  key={path.title}
                  className="io-reveal bg-gradient-to-br from-[#141414] to-[#222222] border border-white/5 hover:border-[#d81300]/30 transition-all duration-300"
                  data-delay="0"
                >
                        ...
                        <div className="flex flex-wrap items-center gap-1">
                          {path.pathSteps.map((step, si) => (
                            <div key={step} className="flex items-center gap-1">
                              <span className="bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] border border-white/10 text-gray-300 text-[10px] px-2 py-1 font-bold">{step}</span>
