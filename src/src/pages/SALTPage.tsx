...
export default function SALTPage() {
  ...
  return (
    <div className="pt-16">
      {/* HEADER */}
      <section className="relative py-24 px-6 overflow-hidden bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a]">
...
<p className="text-2xl md:text-3xl font-black text-white/60 mb-6 tracking-wide">
  ...
  Students in Athletic Leadership have the opportunity to earn a role on the <strong className="text-white">Student Athletic Leadership Team</strong>, where they take on real leadership responsibilities that keep Palmetto Athletics running at every level.
      ...
      {/* ROLES */}
      <section className="bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] py-20 px-6" ref={s2}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-[#d81300]/15">
            {roles.map(({ key, title, desc, responsibilities }, i) => (
              <div key={key}
                className="io-reveal bg-gradient-to-br from-[#141414] to-[#222222] p-6 hover:bg-[#181818] transition-all duration-300 group"
                data-delay={String(i * 60)}>
      ...
      <section className="bg-gradient-to-br from-[#141414] to-[#222222] py-20 px-6" ref={s3}>
        <div className="max-w-7xl mx-auto">
          <div className="io-reveal flex items-center gap-3 mb-3" data-delay="0">
            <div className="w-8 h-0.5 bg-[#d81300]" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
            {placements.map(({ icon, label }, i) => (
              <div key={label}
                className="io-reveal bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] border border-white/5 p-5 text-center hover:border-[#d81300]/40 transition-all duration-300 group card-lift"
                data-delay={String(i * 60)}>
      ...
      {/* 7 HABITS */}
      <section className="bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] py-20 px-6" ref={s4}>
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-2">
              {habits.map(({ num, title, desc }, i) => (
                <div key={num}
                  className="io-reveal flex gap-4 items-start bg-gradient-to-br from-[#141414] to-[#222222] border border-white/5 p-4 hover:border-[#d81300]/20 transition-colors"
      ...
      {/* INSTRUCTOR */}
      <section className="bg-gradient-to-br from-[#141414] to-[#222222] py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] border border-[#d81300]/20 p-8 md:p-10">
