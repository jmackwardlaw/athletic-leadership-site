...
export default function InstructorPage() {
  ...
  return (
    <div className="pt-16">
          ...
          <div>
            ...
            <div className="space-y-3">
              {credentials.map(({ label, value }) => (
                <div key={label} className="flex gap-4 bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] border-l-2 border-[#d81300]/40 px-4 py-3">
          ...
          <div>
            ...
            <div className="space-y-3">
              {education.map(({ degree, school, status }) => (
                <div key={degree} className="bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] border-l-2 border-[#d81300]/40 px-4 py-3">
          ...
          <div ref={s2}>
            ...
            <div className="space-y-3">
              {expertise.map(({ area, desc }, i) => (
                <div key={area}
                  className="io-reveal bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] border border-white/5 p-4 hover:border-[#d81300]/20 transition-colors"
      ...
      {/* COURSE CTA */}
      <section className="bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a] py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-[#141414] to-[#222222] border border-[#d81300]/20 p-8 md:p-10 flex flex-col md:flex-row items-center gap-8">
