...
export default function Nav() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50">
      ...
      <div className="bg-gradient-to-br from-[#0d0d0d] to-[#1a1a1a]/96 backdrop-blur-md border-b border-[#d81300]/30">
      ...
      <div className={`md:hidden overflow-hidden transition-all duration-300 ${menuOpen ? 'max-h-[500px]' : 'max-h-0'}`}>
        <div className="bg-gradient-to-br from-[#141414] to-[#222222] border-b border-[#d81300]/20 px-6 py-4 space-y-1">
          {links.map(({ label, to }) => (
            <NavLink
              key={to}
              to={to}
